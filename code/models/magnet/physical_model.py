...
if __name__=='__main__':
    ...
    psf_tif_folder = r'J:\FoundationData\LF_3D_Recon\F-VCD\Mito_View3\train\H_imgs\cropped'
    psf_list = []
    ...
    raw_view = tifffile.imread(r'J:\FoundationData\LF_3D_Recon\F-VCD\Mito_View3\train\HR\Data030_idx0001.tif')
    ...
    tifffile.imwrite('O_1.tif', np.squeeze(O_guess.cpu().data.numpy()))
    ...
    tifffile.imwrite('deconv_%02d.tif'%iter_num, np.squeeze(intial_vol.cpu().data.numpy()))
    pass
